#!/bin/bash
# Script automatizado para testing de renovación anual
# Ejecutar después de iniciar stripe listen y el servidor

set -e  # Salir si hay error

echo "🧪 =========================================="
echo "   TESTING RENOVACIÓN ANUAL ($390/año)"
echo "==========================================="
echo ""

# Price ID del plan anual
PRICE_ID_ANNUAL="price_1SDYXqBUKmGwbE6Iza5zhYSa"
...
echo "📋 Paso 4: Crear Subscription ANUAL ($390/año)"
...
echo ""
echo "📋 Paso 5: Avanzar Test Clock 366 días para simular renovación anual"
...
echo "   Nuevo tiempo (+366 días): $(date -d @$NEW_TIME '+%Y-%m-%d %H:%M:%S')"
echo ""
...
echo "⏳ Esperando 25 segundos para que se procese la renovación..."
sleep 25
...
echo "   Con: ⏰ Duración: 1Y  ← DEBE SER 1Y, NO 30D!"
echo ""
