...
interface WinningStrategyCardProps {
  images?: string[];
...
// Imágenes para estrategias ganadoras
const defaultImages = [
  '/images/indicators/BTCUSDT.P_2025-09-12_17-00-39_cefde.png', // Indicador BTC/USDT
  '/images/indicators/rsi_scanner.png', // RSI Scanner
  '/api/placeholder/800/600', // Placeholder para más indicadores
];

export default function WinningStrategyCard({
  images = defaultImages,
  autoPlayInterval = 4000,
  showDots = true,
  pauseOnHover = true
}: WinningStrategyCardProps) {
  ...
  return (
    <section className="relative py-16 lg:py-20 bg-apidevs-dark overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Subtle glow effects - Reducidos */}
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-apidevs-primary/2 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-1/3 left-1/5 w-48 h-48 bg-apidevs-primary/3 rounded-full blur-3xl animate-float-reverse [animation-delay:3s]" />
      </div>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="relative group">
            {/* Animated Border Glow - Más sutil */}
            <div className="absolute -inset-1 bg-gradient-primary rounded-3xl blur opacity-10 group-hover:opacity-15 animate-glow transition-opacity duration-500" />
            
            {/* Card Content */}
            <div className="relative bg-apidevs-gray/80 backdrop-blur-sm border border-apidevs-primary/5 rounded-3xl p-6 lg:p-8 shadow-card-dark overflow-hidden">
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="space-y-6 order-1 lg:order-2">
                  {/* Badge */}
                  <div className="inline-flex items-center px-4 py-2 bg-apidevs-primary/10 border border-apidevs-primary/30 rounded-full text-sm text-apidevs-primary font-medium">
                  ...
                  <p className="text-lg text-gray-300 leading-relaxed">
                    Nuestros algoritmos de IA analizan millones de patrones históricos para calibrar automáticamente cada señal. Mientras el 97% de traders confía en indicadores estáticos, tú tendrás señales que se adaptan al mercado en tiempo real.
                  </p>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full h-full max-w-6xl max-h-[85vh] p-3 flex items-center justify-center">
            ...
            <button
              onClick={closeModal}
              className="absolute top-3 right-3 z-10 w-10 h-10 bg-black/60 hover:bg-black/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-colors duration-300 group border border-apidevs-primary/20"
            ...
            {images.length > 1 && (
              <>
                ...
                <button
                  ...
                  className="absolute left-3 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-black/60 hover:bg-black/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110 border border-apidevs-primary/20"
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-black/60 hover:bg-black/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110 border border-apidevs-primary/20"
